"""This has been copied from the python lcd repository belonging
to Dave Hylands, referenced in lcd_api.py. The original file name
is pyb_gpio_lcd.py. This copy of the file has been modified for
use on the Raspberry Pi Pico.
"""
